...
--
-- Name: books; Type: TABLE; Schema: public; Owner: hodev2
--
...
ALTER TABLE public.books OWNER TO hodev2;

--
-- Name: books_id_seq; Type: SEQUENCE; Schema: public; Owner: hodev2
--
...
ALTER TABLE public.books_id_seq OWNER TO hodev2;

--
-- Name: books_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: hodev2
--
...
--
-- Name: covers; Type: TABLE; Schema: public; Owner: hodev2
--
...
ALTER TABLE public.covers OWNER TO hodev2;

--
-- Name: covers_id_seq; Type: SEQUENCE; Schema: public; Owner: hodev2
--
...
ALTER TABLE public.covers_id_seq OWNER TO hodev2;

--
-- Name: covers_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: hodev2
--
...
--
-- Name: books id; Type: DEFAULT; Schema: public; Owner: hodev2
--
...
--
-- Name: covers id; Type: DEFAULT; Schema: public; Owner: hodev2
--
...
--
-- Data for Name: books; Type: TABLE DATA; Schema: public; Owner: hodev2
--

COPY public.books (id, book_name) FROM stdin;
\.


--
-- Data for Name: covers; Type: TABLE DATA; Schema: public; Owner: hodev2
--

COPY public.covers (id, cover_name) FROM stdin;
\.
...
--
-- Name: books_id_seq; Type: SEQUENCE SET; Schema: public; Owner: hodev2
--
...
--
-- Name: covers_id_seq; Type: SEQUENCE SET; Schema: public; Owner: hodev2
--
...
--
-- Name: books books_pkey; Type: CONSTRAINT; Schema: public; Owner: hodev2
--
...
--
-- Name: covers covers_pkey; Type: CONSTRAINT; Schema: public; Owner: hodev2
--
